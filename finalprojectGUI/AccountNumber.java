...
public class AccountNumber extends javax.swing.JFrame {
...
try (BufferedReader br = new BufferedReader(new FileReader(ACCOUNTS_FILE))) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AccountNumber.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AccountNumber().setVisible(true);
            }
        });
    }
