 ...
 * @author ADMIN
 */
public class AccountNumber2 extends javax.swing.JFrame {
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addComponent(AccountNum, javax.swing.GroupLayout.PREFERRED_SIZE, 94, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(layout.createSequentialGroup()
                        .addGap(100, 100, 100)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String accountNum = AccountNum.getText().trim(); 
        
        if(AccountNum.getText().equalsIgnoreCase("")){
            JOptionPane.showMessageDialog(this, "please enter all parameters");
        }
        else if (!isValidAccountNumber(accountNum)){
            ...
            try (BufferedReader br = new BufferedReader(new FileReader(ACCOUNTS_FILE))) {
                ...
                while ((line = br.readLine()) != null) {
                    ...
                    if (data[0].equals(accountNum)) {
                        ...
                        transaction.displayTransactionHistory(accountNum);
...
//                        transaction.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AccountNumber2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AccountNumber2().setVisible(true);
            }
        });
    }
